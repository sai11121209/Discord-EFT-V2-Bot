...
class Link(commands.Cog):
    ...
    async def ja_wiki(self, intrtaction: discord.Integration) -> None:
        text = "wikiwiki.jp"
        embed = discord.Embed(
    ...
    async def en_wiki(self, intrtaction: discord.Integration) -> None:
    ...
    async def market(self, intrtaction: discord.Integration) -> None:
    ...
    async def loadouts(self, intrtaction: discord.Integration) -> None:
        text = "Actual prices, online monitoring, hideout, charts, price history"
        embed = discord.Embed(
    ...
    async def tarkovtools(self, intrtaction: discord.Integration) -> None:
    ...
    async def source(self, intrtaction: discord.Integration) -> None:
